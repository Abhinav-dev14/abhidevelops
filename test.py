...
def speak(text, lang='en'):
    ...
    try:
        ...
        print("gTTS failed:", e)
        print("⚠️ Couldn't speak the text aloud.")
def listen():
    r = sr.Recognizer()
...
def ask_deepseek(prompt, lang='en'):
    ...
    try:
        ...
        if response.status_code != 200:
            print("❌ DeepSeek error:", response.status_code)
...
def control_pc(command):
    ...
    if "open notepad" in command:
        ...
        try:
            ...
            print("❌ Error opening Recycle Bin:", e)
        ...
        try:
            print("🎵 Playing your favorite song now...")
